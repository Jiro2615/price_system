...
def find_existing_listing(asin: str, store_code: str) -> dict[str, str] | None:
    ...
    if row and str(row[0] or "").strip():
        return {"management_number": str(row[0]).strip(), "source": "store_products"}
    return None
