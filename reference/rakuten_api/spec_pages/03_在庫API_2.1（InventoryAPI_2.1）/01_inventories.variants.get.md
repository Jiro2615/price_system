...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/inventoryapi2_1/inventories_variants_get/
...
Overview
この機能を利用すると、商品管理番号とSKU管理番号を指定し、在庫数、出荷リードタイム、配送リードタイム関連の情報を取得することができます。

Endpoint / HTTP Method
Endpoint	HTTP Method
https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/{manageNumber}/variants/{variantId}	GET
Request
HTTP Header
No	Key	Value
...
4	operationLeadTime	出荷リードタイム	no	object	0..1	-
...
curl --location --request GET 'https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/mng1234/variants/sku1' \
...
失敗した場合
Request (curl コマンドを使った例)
curl --location --request GET 'https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/mng1234/variants/sku222' \
--header 'Authorization: ESA xxx'
