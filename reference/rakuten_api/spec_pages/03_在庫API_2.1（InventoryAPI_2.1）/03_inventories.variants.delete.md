...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/inventoryapi2_1/inventories_variants_delete/
...
Endpoint	Method
https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/{manageNumber}/variants/{variantId}	DELETE
Request
HTTP Header
No	Key	Value
...
curl --location --request DELETE 'https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/mng1234/variants/sku1' \
--header 'Authorization: ESA xxx' --header 'Content-Type: application/json'
Response (Status: 204 No Content)
失敗した場合
Request (curl コマンドを使った例)
curl --location --request DELETE 'https://api.rms.rakuten.co.jp/es/2.1/inventories/manage-numbers/mng1234/variants/sku2' \
--header 'Authorization: ESA xxx'--header 'Content-Type: application/json'
