...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/couponapi/thankscouponsearch
サービス: クーポンAPI（CouponAPI）

サービス一覧へ戻る / CouponAPI

RMS WEB SERVICE : thankscoupon.search
この機能を利用すると、条件を指定してサンキュークーポン情報を検索することができます。

Endpoint / HTTP Method
Endpoint	HTTP Method
https://api.rms.rakuten.co.jp/es/1.0/thankscoupons	GET
Request
HTTP Header
...
1	issueStatus	獲得ステータス	int		0,1	3: 期間前
4: 期間中
5: 停止
6: 終了
2	grantStartDate	クーポン獲得開始日時	String		0,1	yyyy-MM-ddTHH:mm:ss+09:00
※ただし有効値はYYYY-MMまで
3	grantEndDate	クーポン獲得終了日時	String		0,1	yyyy-MM-ddTHH:mm:ss+09:00
※ただし有効値はYYYY-MMまで
4	regDate	クーポン登録日	dateTime		0,1	yyyy-MM-ddTHH:mm:ss+09:00
※ただし有効値はYYYY-MMまで
5	hits	件数	int		0,1	デフォルト： 30
最大値：100
全角数字を半角に変換
6	page	ページ番号	int		0,1	デフォルト： 1
全角数字を半角に変換
Path parameters
None
...
2	result.allCount	データ件数	int	4	0,1	
3	result.thanksCoupons	サンキュークーポン情報リスト	XML:thanksCoupons	-	0,1	
XML:errors
No	Element	Description	Type	Size(byte)	Multiplicity	Note
...
XML:thanksCoupons
No	Element	Description	Type	Size(byte)	Multiplicity	Note
1	thanksCoupons.thanksCoupon	サンキュークーポン情報	XML:thanksCoupon	-	0..n	
XML:thanksCoupon
No	Element	Description	Type	Size(byte)	Multiplicity	Note
...
8	thanksCoupon.discountType	割引きプラン	int	4	1	1： 定額値引き
2： 定率値引き
9	thanksCoupon.discountFactor	割引因子	int	4	1	discountTypeによって値が異なる
...
5: 停止
6: 終了
16	thanksCoupon.useCount	利用数	int	4	1	
17	thanksCoupon.getCount	獲得数	int	4	1	
18	thanksCoupon.regDate	登録日時	dateTime	-	1	
19	thanksCoupon.lastUpdateDate	最終更新日時	dateTime	-	1	
20	thanksCoupon.thanksAutoGetConditions	サンキュークーポン獲得条件リスト	XML:thanksAutoGetConditions	-	1	
21	thanksCoupon.thanksOtherConditions	サンキュークーポンその他条件リスト	XML:thanksOtherConditions	-	1	
...
※2　couponCaption等の任意項目が空の場合はレスポンスに含まれません。
...
<result>
    ...
    <thanksCoupons>
        <thanksCoupon>
            ...
            <shopUrl>http://www.rakuten.co.jp/demoshop_001</shopUrl>
            ...
            <pcRedirectUrl>http://www.rakuten.co.jp/demoshop_001</pcRedirectUrl>
