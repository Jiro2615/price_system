...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/rakutenpayorderapi/getorder
...
※RMSの受注管理画面で表示されている「総合計（税込）」および「商品小計（税込）」の項目について、
　本機能ではResponseされませんが、その他項目から算出可能です。計算方法の詳細はこちら をご確認ください。
...
Response
Tips：RMSの受注管理画面で表示されている「総合計（税込）」および「商品小計（税込）」の項目について
...
52	支払方法モデル	SettlementModel	yes	SettlementModel	-	-		
53	配送方法モデル	DeliveryModel	yes	DeliveryModel	-	-		
54	ポイントモデル	PointModel	yes	PointModel	-	-		
...
電話番号の1,2,3の内、nullは１つまで許可


	String	382	-	※ソーシャルギフト注文において受取情報が未入力の場合、ダミーデータ"999"になります。	090
