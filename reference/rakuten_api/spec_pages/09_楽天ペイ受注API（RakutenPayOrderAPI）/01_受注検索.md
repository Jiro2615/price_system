...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/rakutenpayorderapi/searchorder
...
※2026年1月22日（木）の支払方法名変更に伴い、新旧名称どちらの注文も取得対象となります。	2
...
24	当日出荷フラグ	oneDayOperationFlag	no	Number	1	-	以下のいずれか
0: 1営業日以内出荷の注文かどうかを問わず取得する
1: 1営業日以内出荷の注文だけを取得
※購入時に最短お届け可能日が指定された注文、またはソーシャルギフト注文において受取情報入力時に最短お届け可能日が指定された注文	1
