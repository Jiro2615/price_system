...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/inventoryapi2/upsertinventory
...
Overview
この機能を利用すると、商品管理番号とSKU管理番号を指定し、在庫数を登録・更新することができます。
...
Endpoint	HTTP Method
https://api.rms.rakuten.co.jp/es/2.0/inventories/manage-numbers/{manageNumber}/variants/{variantId}	PUT
Request
HTTP Header
No	Key	Value
