...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/inventoryapi2/getbulkinventories
...
Overview
この機能を利用すると、商品管理番号とSKU管理番号を指定し、最大で1000件の在庫数を一括で取得できます。

Endpoint / HTTP Method
Endpoint	HTTP Method
https://api.rms.rakuten.co.jp/es/2.0/inventories/bulk-get	POST
Request
HTTP Header
No	Key	Value
...
1	inventories	在庫情報	yes	List<inventory>	0..1000	在庫情報リスト
Level2: inventory
No	Parameter Name	Logical Name	Not Null	Type	Multiplicity	Description
