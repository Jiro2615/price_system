...
URL: https://webservice.rms.rakuten.co.jp/merchant-portal/view/ja/common/1-1_service_index/inquirymanagementapi/inquiries_patch_completeincomplete/
サービス: 問い合わせ管理API（InquiryManagementAPI）

サービス一覧へ戻る / InquiryManagementAPI

RMS WEB SERVICE : inquirymngapi.inquiries.patch.complete/incomplete
Overview

この機能を利用すると、指定された複数の問い合わせの完了ステータスを変更することができます。

Endpoint / HTTP Method
Endpoint	HTTP Method	Note


https://api.rms.rakuten.co.jp/es/1.0/inquirymng-api/inquiries/complete

	PATCH	

指定された問い合わせを”完了”状態に変更します。




https://api.rms.rakuten.co.jp/es/1.0/inquirymng-api/inquiries/incomplete

	PATCH	

指定された問い合わせを”未完了”状態に変更します。
